...
<!--	<h1>STUDENT ADMISSION FORM </h1> -->
	...
	<div id="navBar">
		<ul>
			...
			<li><a href="rls.php">Rls</a></li>
			<li><a href="Rlsa.php" >Rlsa</a></li>
			</div>
		</ul>
	</div>
	
	<form class="formEnter" action="rlsa.php" method="POST">
	
		<h2>Admin</h2>
		
		<br>
		<input id="upload" type="button"  name="upload" value="Upload">  <!-- value="<?php echo  $rlsa_id?>"  -->
		 <br><br>
		
			<br>
		<input id="delete" type="button" name="delete" value="Delete">  <!-- value="<?php echo  $rlsa_password?>"  -->
